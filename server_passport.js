...
const url =
  "mongodb+srv://admin:<18rvZfM4zFkv7AcV>@cluster0.erhuyqg.mongodb.net/?appName=Cluster0y";
let mydb;
mongoclient
  .connect(url)
  .then((client) => {
...
passport.use(
  new LocalStrategy(
    ...
    function (inputid, inputpw, done) {
      ...
      // mydb.collection('account').findOne({ userid : 입력한아이디 }, function (에러, 결과) {
      //   console.log(결과);
      ...
      mydb
        ...
        .then((result) => {
          ...
          if (result.userpw == inputpw) {
            ...
            //res.render("login.ejs");
            done(null, false, { message: "비번틀렸어요" });
          }
        });
      //done(null, false);
    }
